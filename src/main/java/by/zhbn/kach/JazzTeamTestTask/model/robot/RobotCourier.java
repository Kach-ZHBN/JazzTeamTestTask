...
public class RobotCourier extends Robot {

    public RobotCourier(String name, Manager manager, Logger logger) {
        super(name, manager, logger, RobotType.COURIER);
    }

    @Override
    public void performUniqueTask(Task task) throws InterruptedException {
        if (task.getTaskType() == TaskType.DELIVER) {
